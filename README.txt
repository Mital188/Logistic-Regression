This assignment is implemented using Python 3.5. The code implements logistic regression algorithm and produces the accuracy of the algorith with and without the inclusion of stop words 
